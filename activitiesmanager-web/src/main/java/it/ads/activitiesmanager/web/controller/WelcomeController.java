...
//	private IUserDS userService;
	...
	public ModelAndView adminPage() {
		...
		ModelAndView model = new ModelAndView();
		model.addObject("welcomeMessage", "Welcome to \"ADMIN\" area");
		model.setViewName("welcome");
		return model;
	}
	...
	public ModelAndView login(@RequestParam(value = "error", required = false) String error,
		...
		ModelAndView model = new ModelAndView();
		if (error != null) {
			model.addObject("error", "Invalid user/pwd");
		}

		if (logout != null) {
			model.addObject("msg", "Logout regularly completed");
		}
...
//	}
	...
	public ModelAndView accesssDenied(Principal user) {
		ModelAndView model = new ModelAndView();
		model.addObject("errorMessage", "You don't have permission to access to this page");
