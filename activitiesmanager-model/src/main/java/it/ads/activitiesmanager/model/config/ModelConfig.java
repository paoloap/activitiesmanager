package it.ads.activitiesmanager.model.config;
...
import it.ads.activitiesmanager.model.dao.UserDao;
...
public class ModelConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[]{"it.ads.activitiesmanager.model.entity"}); // package where are the @Entity classes are located, ususaly your domain package
